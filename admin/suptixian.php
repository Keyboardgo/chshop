...
<?php adminpermission('suptixian', 1);?>
<div class="block">
<div class="block-title clearfix">
<h2>余额提现列表</h2><?php if($conf['sup_daifu']>0){?><a class="btn btn-xs btn-info pull-right" href="javascript:config()">自动转账配置</a>&nbsp;<a class="btn btn-xs btn-primary pull-right" href="javascript:pl_config()">批量转账选中记录</a><?php }?>
</div>
...
<script src="assets/js/suptixian.js?ver=<?php echo VERSION ?>"></script>
</body>
</html>