...
<h2>余额提现列表</h2><a class="btn btn-xs btn-info pull-right" href="javascript:config()">自动转账配置</a>&nbsp;<a class="btn btn-xs btn-primary pull-right" href="javascript:pl_config()">批量转账选中记录</a>
</div>
