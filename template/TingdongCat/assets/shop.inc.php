  ...
  #num_min, #num_add {
    background: rgba(93, 156, 255, 0.1) !important;
		...
		<div id="goodTypeContents">
			...
			<div id="inputsname"></div>
			<div id="alert_frame" class="alert alert-success animated rubberBand" style="display:none;background: linear-gradient(to right,#a9dbff,#b4d1f9);font-weight: bold;color:white;border-radius: 12px;box-shadow: 1px 2px 8px rgba(0, 0, 0, 0.2);"></div>
			<?php if($conf['shoppingcart']==1){?>
			...
			<div class="payment-buttons">
				<input type="submit" id="submit_buy" class="btn btn-primary btn-block buybutton" value="立即购买">
				</div>
			</div>
			<?php }?>
