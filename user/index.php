	...
	<div class="panel panel-default">
		<div class="panel-heading font-bold">
			<div class="widget-content text-right clearfix">
				<img src="<?php echo $faceimg ?>" alt="Avatar" width="66" class="img-circle img-thumbnail img-thumbnail-avatar pull-left">
...
<table class="table">
	<tbody>
		...
		?>
		<tr>
			<td><a href="cdomain.php" class="btn btn-warning btn-block"><i class="fa fa-sign-out"></i><br/><b>域名更换</b></a></td>
...
<div class="col-lg-4 col-md-6 col-sm-12">
	<div class="panel panel-default">
		<div class="panel-heading font-bold text-center"><h3 class="panel-title"><i class="fa fa-globe"></i>&nbsp;&nbsp;<b>我的站点信息</b></h3></div>
