...
if($verify_result && ($conf['alipay_api']==2 || $conf['qqpay_api']==2 || $conf['wxpay_api']==2 || $conf['qqpay_api']==8 || $conf['wxpay_api']==8 || $conf['wxpay_api']==9 || $conf['recharge_api']==2 || $conf['recharge_api']==8 || $conf['recharge_api']==10) && !empty($pay_config['pid']) && !empty($pay_config['key'])) {
